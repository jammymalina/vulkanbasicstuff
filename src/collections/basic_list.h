    ...
    bool function_prefix##_get(name *c, size_t index, type *value) {               \
        ...
        *value = c->elements[index];                                               \
        return true;                                                               \
                                                                                   ...
                                                                                   \
    bool function_prefix##_remove(name *c, size_t index, free_func f) {            \
        if (index >= max_size)                                                     \
            return false;                                                          \
        if (f)                                                                     \
            f(c->elements[index]);                                                     \
        ...
        return true;                                                               \
                                                                                   ...
                                                                                   \
    bool function_prefix##_set(name *c, size_t index, type element, free_func f) { \
        if (index >= max_size)                                                     \
            return false;                                                          \
		if (f)                                                                     \
			f(c->elements[index]);                                                 \
        ...
        return true;                                                               \
                                                                                   ...
                                                                                   \
    void function_prefix##_clear(name *c, free_func f) {                           \
        if (f) {                                                                   \
            for (size_t i = 0; i < c->size; i++)                                   \
                f(c->elements[i])                                                  \
        }                                                                          \
